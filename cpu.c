...
static const CpuInstruction cpu_instruction_lookup[] = {
  ...
  [0x01] = {.name="ORA", .cycles_left=5, .mem_needed=2, .addressing_mode=INDIRECT_X},
  ...
  [0x05] = {.name="ORA", .cycles_left=3, .mem_needed=2, .addressing_mode=ZERO_PAGE},
  [0x06] = {.name="ASL", .cycles_left=5, .mem_needed=2, .addressing_mode=ZERO_PAGE},
  ...
  [0x09] = {.name="ORA", .cycles_left=2, .mem_needed=2, .addressing_mode=IMPLIED},
  [0x0A] = {.name="ASL", .cycles_left=2, .mem_needed=1, .addressing_mode=ACCUMULATOR},
  [0x0B] = {.name="???", .cycles_left=0, .mem_needed=0, .addressing_mode=NONE},
  [0x0C] = {.name="???", .cycles_left=0, .mem_needed=0, .addressing_mode=NONE},
  [0x0D] = {.name="ORA", .cycles_left=4, .mem_needed=3, .addressing_mode=ABSOLUTE},
  [0x0E] = {.name="ASL", .cycles_left=6, .mem_needed=3, .addressing_mode=ABSOLUTE},
  [0x0F] = {.name="???", .cycles_left=0, .mem_needed=0, .addressing_mode=NONE},
  [0x10] = {.name="???", .cycles_left=0, .mem_needed=0, .addressing_mode=NONE},
  [0x11] = {.name="???", .cycles_left=0, .mem_needed=0, .addressing_mode=NONE},
  ...
  [0x15] = {.name="???", .cycles_left=0, .mem_needed=0, .addressing_mode=NONE},
  [0x16] = {.name="???", .cycles_left=0, .mem_needed=0, .addressing_mode=NONE},
  [0x17] = {.name="???", .cycles_left=0, .mem_needed=0, .addressing_mode=NONE},
  [0x18] = {.name="???", .cycles_left=0, .mem_needed=0, .addressing_mode=NONE},
  [0x19] = {.name="???", .cycles_left=0, .mem_needed=0, .addressing_mode=NONE},
  ...
  [0x1D] = {.name="???", .cycles_left=0, .mem_needed=0, .addressing_mode=NONE},
  [0x1E] = {.name="???", .cycles_left=0, .mem_needed=0, .addressing_mode=NONE},
  [0x1F] = {.name="???", .cycles_left=0, .mem_needed=0, .addressing_mode=NONE},
  [0x20] = {.name="???", .cycles_left=0, .mem_needed=0, .addressing_mode=NONE},
  [0x21] = {.name="???", .cycles_left=0, .mem_needed=0, .addressing_mode=NONE},
  [0x22] = {.name="???", .cycles_left=0, .mem_needed=0, .addressing_mode=NONE},
  [0x23] = {.name="???", .cycles_left=0, .mem_needed=0, .addressing_mode=NONE},
  [0x24] = {.name="???", .cycles_left=0, .mem_needed=0, .addressing_mode=NONE},
  [0x25] = {.name="???", .cycles_left=0, .mem_needed=0, .addressing_mode=NONE},
  [0x26] = {.name="???", .cycles_left=0, .mem_needed=0, .addressing_mode=NONE},
  [0x27] = {.name="???", .cycles_left=0, .mem_needed=0, .addressing_mode=NONE},
  [0x28] = {.name="???", .cycles_left=0, .mem_needed=0, .addressing_mode=NONE},
  [0x29] = {.name="???", .cycles_left=0, .mem_needed=0, .addressing_mode=NONE},
  [0x2A] = {.name="???", .cycles_left=0, .mem_needed=0, .addressing_mode=NONE},
  [0x2B] = {.name="???", .cycles_left=0, .mem_needed=0, .addressing_mode=NONE},
  [0x2C] = {.name="???", .cycles_left=0, .mem_needed=0, .addressing_mode=NONE},
  [0x2D] = {.name="???", .cycles_left=0, .mem_needed=0, .addressing_mode=NONE},
  [0x2E] = {.name="???", .cycles_left=0, .mem_needed=0, .addressing_mode=NONE},
