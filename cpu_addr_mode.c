...
CpuAddressingModeResult immediate_addressing_mode(const CpuState* cpu){
  /*
    ...
    the operand
   */
  CpuAddressingModeResult res = {.operand=cpu->bus[cpu->pc+1], .pc_offset=2, .additional_cycles=0};
  return res;
}
...
CpuAddressingModeResult absolute_addressing_mode(const CpuState* cpu){
     ...
     CpuAddressingModeResult res = {.operand=(hi_order_bits << 8) | lo_order_bits, .pc_offset=3, .additional_cycles=0};
     return res;
}
...
CpuAddressingModeResult relative_addressing_mode(const CpuState* cpu){
  CpuAddressingModeResult res = {.operand=cpu->bus[cpu->pc+1], .pc_offset=2};
  return res;
}
...
CpuAddressingModeResult indirect_x_addressing_mode(const CpuState* cpu){
  ...
  CpuAddressingModeResult res = {.operand=addr, .pc_offset=3, .additional_cycles=0};
  return res;
}
...
CpuAddressingModeResult implied_addressing_mode(const CpuState* cpu){
  ...
  CpuAddressingModeResult res = {.operand=0, .pc_offset=1, .additional_cycles=0};
  return res;
}
